...
def create_feed_info_content() -> None:
    ...
    feed_info_txt_content = "feed_publisher_name,feed_publisher_url,feed_lang,feed_start_date,feed_end_date\n"
    feed_info_txt_content += "MRC de Joliette,https://mrcjoliette.qc.ca/transport-mrc-joliette/,fr,20250101,20251231\n"
